Feature: Journey splits
  ...
  Scenario: Train splits
    Given a query between "CHX" and "CBW" on "2020-03-26" at "07:37"
  ...
  Scenario: Train splits
    Given a query between "CHX" and "RAM" on "2020-03-26" at "16:10"
  ...
  Scenario: Train splits
    Given a query between "CHX" and "DVP" on "2020-03-26" at "07:09"
  ...
  Scenario: Train splits
    Given a query between "CHX" and "RAM" on "2020-03-26" at "13:10"
  ...
  Scenario: Train splits
    Given a query between "CHX" and "CBW" on "2020-03-26" at "23:40"
