Feature: Journey joins another train
  ...
  Scenario: Train joins another train
    Given a query between "RAM" and "CHX" on "2020-03-25" at "17:18"
  ...
  Scenario: Train joins another train
    Given a query between "RAM" and "CHX" on "2020-03-25" at "08:14"
  ...
  Scenario: Train joins another train
    Given a query between "RAM" and "CHX" on "2020-03-25" at "16:17"
  ...
  Scenario: Train joins another train
    Given a query between "RAM" and "CHX" on "2020-03-25" at "18:10"
  ...
  Scenario: Train joins another train
    Given a query between "RAM" and "CHX" on "2020-03-25" at "09:08"
