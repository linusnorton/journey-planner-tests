...
Feature: Public time different to scheduled time
  ...
  Scenario: Public departure time differs to scheduled departure time by more than a minute between STP and LDS
    Given a query between "STP" and "LDS" on "2020-04-10" at "18:34"
  ...
  Scenario: Public departure time differs to scheduled departure time by more than a minute between PAD and RDG
    Given a query between "PAD" and "RDG" on "2020-04-10" at "05:43"
  ...
  Scenario: Public departure time differs to scheduled departure time by more than a minute between PAD and RDG
    Given a query between "PAD" and "RDG" on "2020-04-10" at "18:43"
  ...
  Scenario: Public departure time differs to scheduled departure time by more than a minute between PAD and RDG
    Given a query between "PAD" and "RDG" on "2020-04-10" at "06:43"
  ...
  Scenario: Public departure time differs to scheduled departure time by more than a minute between PAD and RDG
    Given a query between "PAD" and "RDG" on "2020-04-10" at "19:43"
